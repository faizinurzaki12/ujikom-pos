...
CREATE DATABASE IF NOT EXISTS `percobaan` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_uca1400_ai_ci */;
USE `percobaan`;

-- Dumping structure for table percobaan.cache
...
-- Dumping structure for table percobaan.cache_locks
...
-- Dumping structure for table percobaan.failed_jobs
...
-- Dumping structure for table percobaan.item_penjualan
CREATE TABLE IF NOT EXISTS `item_penjualan` (
  ...
  CONSTRAINT `item_penjualan_produk_id_foreign` FOREIGN KEY (`produk_id`) REFERENCES `produk` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Data exporting was unselected.

-- Dumping structure for table percobaan.jenis
...
-- Dumping structure for table percobaan.job_batches
...
-- Dumping structure for table percobaan.jobs
...
-- Dumping structure for table percobaan.migrations
...
-- Dumping structure for table percobaan.password_reset_tokens
...
-- Dumping structure for table percobaan.penjualan
...
-- Dumping structure for table percobaan.produk
...
-- Dumping structure for table percobaan.roles
...
-- Dumping structure for table percobaan.sessions
